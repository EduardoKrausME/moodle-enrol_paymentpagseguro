...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'paymentpagseguro'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/paymentpagseguro/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_paymentpagseguro', format_string($course->fullname));
